                <div class="form-group">
                    ...
                    <?php if ($errors['title']) echo (create_err_msg($errors['title'])) ?>
                </div>
                <div class="form-group">
                    ...
                    <?php if ($errors['category_id']) echo (create_err_msg($errors['category_id'])) ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <?php if ($errors['image']) echo (create_err_msg($errors['image'])) ?>
                </div>
